...
parser.add_argument('-model', help='Model', type=str, default='RoAN_DES', choices = ['RoAN_DET', 'RoAN_DED', 'RoAN_DES'])
...
parser.add_argument('-neg_ratio', help='Negative ratio', type=int, default=500, choices = [5,500])
